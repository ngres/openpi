...
```bash
uv run ./scripts/serve_policy.py policy:checkpoint --policy.config=pi05_leros2_aa --policy.dir=checkpoints/pi05_leros2_aa/pi05_leros2_aa/19999 --default_prompt='Pick up the red cube and place it on the black square.'
```
